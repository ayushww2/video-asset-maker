...
- **Seedance 2.0 Mini** via **ElevenLabs** (`POST /v1/flows/video`, `model_id: bytedance-seedance-v2-mini`, **480p**, silent, **4s**). The Railway worker runs in **Singapore** because Seedance 2 is blocked from US IPs. Isolated residency APIs need a separate key and do not work with this account.
